...
class RoborockApi:
    ...
    def _parse_status(self, status):
        ...
        return{
            ...
            "dirty_tank_missing": dock_error == RoborockDockErrorCode.dirty_tank_latch_open,
            "waste_water_tank_full": dock_error == RoborockDockErrorCode.waste_water_tank_full,
            "basin_blocked": dock_error == RoborockDockErrorCode.cleaning_tank_full_or_blocked,
        }
